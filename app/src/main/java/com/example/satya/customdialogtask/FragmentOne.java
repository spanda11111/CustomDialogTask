...
public class FragmentOne extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        ImageView im1 = (ImageView) v.findViewById(R.id.im1);
        ImageView im2 = (ImageView) v.findViewById(R.id.im2);
        ImageView im3 = (ImageView) v.findViewById(R.id.im3);
        ImageView im4 = (ImageView) v.findViewById(R.id.im4);
